...
public class sector_t implements IReadableDoomObject, IPackableDoomObject, Resettable {
    ...
    public static final int ORIG_FRICTION_FACTOR = 2048;
    /** Boom generalized sector special bit: friction effect enabled in this sector. */
    public static final int FRICTION_MASK = 0x100;
    /** Boom generalized sector special bit: pusher/puller effects enabled. */
    public static final int PUSH_MASK = 0x200;
    /**
     ...
     */
    public int boomFriction = ORIG_FRICTION;
    /** The matching thrust factor (mud crawls, ice gives poor footing). */
    public int boomMoveFactor = ORIG_FRICTION_FACTOR;
