            ...
            case 1:
                ...
                if (res == result_e.pastdest) {
                    switch (ceiling.type) {
                        ...
                        case genCeilingChgT:
                        case genCeilingChg:
                            if (ceiling.genTexture >= 0) {
                                ceiling.sector.ceilingpic = ceiling.genTexture;
                            }
                            if (ceiling.genNewSpecial >= 0) {
                                ceiling.sector.special = (short) ceiling.genNewSpecial;
                            }
                        case genCeiling:
                        case raiseToHighest:
    ...
    default boolean DoCeiling(line_t line, ceiling_e type) {
        ...
        while ((secnum = FindSectorFromLineTag(line, secnum)) >= 0) {
            ...
            switch (type) {
                ...
                case lowerToMaxFloor:
                    ceiling.bottomheight = sec.FindHighestFloorSurrounding();
                    ceiling.direction = -1;
                    ceiling.speed = CEILSPEED;
                    break;
            }
